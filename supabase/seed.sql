...
insert into public.exercise_library (slug, name, instruction, safety_note, categories, beginner_variation, difficulty) values
  ...
  ('gentle-hops', 'Gentle Hops', 'Hop softly from one foot to the other with a light rhythm, landing quietly through the ball of the foot. Keep the hops low and controlled.', 'Skip the hops if your joints feel tender today and march instead.', '{"endurance"}', 'March in place with a little bounce instead of hopping.', 'beginner'),
