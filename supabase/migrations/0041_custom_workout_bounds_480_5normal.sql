-- 0041_custom_workout_bounds_480_5normal.sql
-- Repair: 0038's file was amended after it was applied locally (1be6e07),
-- so the live complete_custom_workout still enforces the old 120s floor
-- without the 5+-normal -> 400 branch. Re-emit the function exactly as
-- the 0038 file specifies (480-900s window, 30/45/60s blocks, 30s rests,
-- 12-segment cap, 100/200/400 classification incl. the 5+-normal rule).
-- Migrations are immutable once applied - this forward repair is the fix,
-- not another edit of 0038.
