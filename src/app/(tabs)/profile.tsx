...
const FRAME_HOLE_CENTER: Record<string, { x: number; y: number; size: number }> = {
  'frame-default': { x: 253.8, y: 236.3, size: 183.6 },
  'frame-level-05': { x: 255.8, y: 233.9, size: 140.8 },
  'frame-level-10': { x: 255.4, y: 243.5, size: 140.8 },
  'frame-level-25': { x: 232.3, y: 247.5, size: 140.8 },
  'frame-level-50': { x: 265.1, y: 250.5, size: 140.8 },
  'frame-level-100': { x: 277.6, y: 254.5, size: 140.8 },
  premium_frame: { x: 256, y: 256, size: 140.8 },
};
const DEFAULT_HOLE_CENTER = { x: 256, y: 256, size: 140.8 };
